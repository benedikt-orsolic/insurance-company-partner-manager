...
class PartnerDisplay(bool hasPolicyTrigger, EPartnerTypeId partnerTypeId, bool createdSuccess, string fullName, DateTime createdAtUtc, bool isForeign, string gender, string partnerNumber, ulong? croatianPin = null)
{
